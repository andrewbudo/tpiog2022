...
**Когда используется глобальная переменная внутри функции, находящейся в том же файле, где происходит объявление глобальной переменной, то можно объявлять ее как extern**
...
**Внутренее связывание: при использовании переменных и т.п. объявлянных в текущей еденице трансляции (нп. локальные переменные и т.д.).
Внешнее - всё, что использует ключевое слово extern.**
